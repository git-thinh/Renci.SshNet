...
namespace Renci.SshNet
{
    ...
    public partial class SftpClient : BaseClient
    {
            ...
            object state, Action<ulong> uploadCallback = null)
        {
            ...
            return BeginUploadFile(input, path, flags, asyncCallback, state, uploadCallback);
        }
        ...
        /// <param name="input">Data input stream.</param>
        /// <param name="path">Remote file path.</param>
        /// <param name="flags">Flags to use when opening the file
        /// <param name="asyncCallback">The method to be called when the asynchronous write operation is completed.</param>
        /// <param name="state">A user-provided object that distinguishes this particular asynchronous write request from other requests.</param>
        /// <param name="uploadCallback">The upload callback.</param>
        /// <returns>
        ...
        /// Method calls made by this method to <paramref name="input" />, may under certain conditions result in exceptions thrown by the stream.
        /// </remarks>
        public IAsyncResult BeginUploadFile(Stream input, string path, Flags flags, AsyncCallback asyncCallback,
            object state, Action<ulong> uploadCallback = null)
        {
            CheckDisposed();
